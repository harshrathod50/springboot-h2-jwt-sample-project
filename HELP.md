...
* The original package name 'dev.rathod.harsh.springboot-h2-jwt-sample-project' is invalid and this project uses 'dev.rathod.harsh.springboot_h2_jwt_sample_project' instead.
